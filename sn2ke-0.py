...
def respawn(k):
    global s1_position, s1_body, s2_body, s2_position, s1_direction, s2_direction, s1_change_to, s2_change_to
    if k == 1:
        s1_position = [100, 50]
